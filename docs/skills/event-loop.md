...
![](/blog/skills/event-loop-1.gif)执行栈可视化
...
![](/blog/skills/event-loop-2.jpg)函数执行顺序
...
![](/blog/skills/event-loop-3.jpg)爆栈
...
![](/blog/skills/event-loop-4.jpg)事件循环
