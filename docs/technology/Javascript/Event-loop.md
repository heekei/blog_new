...
![](/blog_new/technology/event-loop-1.gif)执行栈可视化
...
![](/blog_new/technology/event-loop-2.jpg)函数执行顺序
...
![](/blog_new/technology/event-loop-3.jpg)爆栈
...
![](/blog_new/technology/event-loop-4.jpg)事件循环
...
![](/blog_new/technology/event-loop.png)
